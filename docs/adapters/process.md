...
- Running a Python script that calls the Sanad AI EOI API
...
1. Sanad AI EOI spawns the configured command as a child process
2. Standard Sanad AI EOI environment variables are injected (`PAPERCLIP_AGENT_ID`, `PAPERCLIP_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the Sanad AI EOI API and perform work.
