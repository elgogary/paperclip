...
summary: What adapters are and how they connect agents to Sanad AI EOI
---

Adapters are the bridge between Sanad AI EOI's orchestration layer and agent runtimes. Each adapter knows how to invoke a specific type of AI agent and capture its results.

## How Adapters Work

When a heartbeat fires, Sanad AI EOI:
