...
Manage companies within your Sanad AI EOI instance.
...
Company logo uploads use the normal Sanad AI EOI attachment size limit.
...
| `logoUrl` | string | Optional Sanad AI EOI asset content path for the stored logo image |
