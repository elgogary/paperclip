...
Sanad AI EOI exposes a RESTful JSON API for all control plane operations.
...
- Run audit trail: include `X-Sanad AI EOI-Run-Id` header on all mutating requests during heartbeats
