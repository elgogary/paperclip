...
Sanad AI EOI supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying Sanad AI EOI?** Use `local_trusted` (the default)
