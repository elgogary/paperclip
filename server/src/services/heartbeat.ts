// heartbeat.ts — Heartbeat service factory (orchestrator stub).
// Pure helpers, types, and constants live in ./heartbeat-helpers.ts.
...
// Import all helpers used inside the factory
import {
