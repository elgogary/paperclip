// heartbeat-wakeup.ts — Wakeup enqueue and issue-execution promotion extracted from heartbeat factory.
// Contains enqueueWakeup and releaseIssueExecutionAndPromote.
...
export function createWakeupOps(db: Db, $: any) {
  ...
  return { enqueueWakeup, releaseIssueExecutionAndPromote };
}
